...
class MyFrame(Frame):
    ...
    def __init__(self, master):
        ...
        _ambient  = Scale(frame5, from_=0, to=0.7, command = self.light_ambient )
        _diffuse  = Scale(frame5, from_=0, to=0.7, command = self.light_diffuse )
        _specular = Scale(frame5, from_=0, to=0.7, command = self.light_specular)
        _position = Scale(frame5, from_=0, to=0.7, command = self.light_position)
